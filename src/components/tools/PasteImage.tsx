...
export default function PasteImageTool() {
  ...
  const downloadImage = () => {
    ...
    link.href = image;
    link.download = `paste-image-${dateStamp}.png`;
      ...
      {!image ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center bg-muted/30 rounded-xl border p-4 min-h-[50vh] overflow-hidden">
            <div ref={containerRef} className="relative inline-block touch-none select-none">
              <img
                ref={imageRef}
                src={image}
                alt="Pasted content"
