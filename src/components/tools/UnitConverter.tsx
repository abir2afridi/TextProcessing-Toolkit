...
const UNIT_CATEGORIES: Record<string, UnitCategory> = {
  length: {
    ...
    baseUnit: "meter",
    units: {
      meter: { name: "Metre", symbol: "m", toBase: (v) => v, fromBase: (v) => v },
      kilometer: { name: "Kilometre", symbol: "km", toBase: (v) => v * 1000, fromBase: (v) => v / 1000 },
      centimeter: { name: "Centimetre", symbol: "cm", toBase: (v) => v / 100, fromBase: (v) => v * 100 },
      millimeter: { name: "Millimetre", symbol: "mm", toBase: (v) => v / 1000, fromBase: (v) => v * 1000 },
  ...
  data: {
    ...
    units: {
      ...
      petabyte: { name: "Petabyte", symbol: "PB", toBase: (v) => v * 1024 ** 5, fromBase: (v) => v / 1024 ** 5 },
      bit: { name: "Bit", symbol: "b", toBase: (v) => v / 8, fromBase: (v) => v * 8 },
      kilobit: { name: "Kilobit", symbol: "Kb", toBase: (v) => (v * 1024) / 8, fromBase: (v) => (v * 8) / 1024 },
      megabit: { name: "Megabit", symbol: "Mb", toBase: (v) => (v * 1024 ** 2) / 8, fromBase: (v) => (v * 8) / 1024 ** 2 },
      gigabit: { name: "Gigabit", symbol: "Gb", toBase: (v) => (v * 1024 ** 3) / 8, fromBase: (v) => (v * 8) / 1024 ** 3 },
    },
  },
  temperature: {
    name: "Temp",
  ...
  speed: {
    ...
    baseUnit: "mps",
    units: {
      mps: { name: "Metres/sec", symbol: "m/s", toBase: (v) => v, fromBase: (v) => v },
  ...
  area: {
    ...
    baseUnit: "sqm",
    units: {
      sqm: { name: "Square metre", symbol: "m\u00B2", toBase: (v) => v, fromBase: (v) => v },
      sqkm: { name: "Square km", symbol: "km\u00B2", toBase: (v) => v * 1000000, fromBase: (v) => v / 1000000 },
  ...
  volume: {
    ...
    baseUnit: "liter",
    units: {
      liter: { name: "Litre", symbol: "L", toBase: (v) => v, fromBase: (v) => v },
      milliliter: { name: "Millilitre", symbol: "mL", toBase: (v) => v / 1000, fromBase: (v) => v * 1000 },
      cubicMeter: { name: "Cubic metre", symbol: "m\u00B3", toBase: (v) => v * 1000, fromBase: (v) => v / 1000 },
      gallon: { name: "Gallon (US)", symbol: "gal", toBase: (v) => v * 3.78541, fromBase: (v) => v / 3.78541 },
      gallonUK: { name: "Gallon (UK)", symbol: "gal UK", toBase: (v) => v * 4.54609, fromBase: (v) => v / 4.54609 },
      ...
      fluidOz: { name: "Fluid oz (US)", symbol: "fl oz", toBase: (v) => v * 0.0295735, fromBase: (v) => v / 0.0295735 },
    },
  },
};
